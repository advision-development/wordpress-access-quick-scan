...
**Version 0.8.8** on `main` · **697 assertions, 0 failures** · `./build.sh` produces a
zip.
...
**Released as `v0.8.8`**, and the release workflow asserts the tag equals the header before
