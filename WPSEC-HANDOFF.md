...
**Version 0.9.0** on `main` · **707 assertions, 0 failures** · `./build.sh` produces a
zip.
...
**Released as `v0.9.0`** (2026-08-24), and the release workflow asserts the tag equals the header before
